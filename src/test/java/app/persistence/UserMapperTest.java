...
class UserMapperTest {
    ...
    void testLogin() throws DatabaseException {
        ...
        assertNotNull(user);
        assertEquals("Morten", user.getName());
    ...
    void testCreateUser() throws DatabaseException {
        User user = userMapper.createUser("Laura","1234");
        assertNotNull(user);
    ...
    @Test
    void testDeleteMember() throws DatabaseException {
        User user = userMapper.getUserById(1);
        assertNotNull(user);
        userMapper.deleteMember(user.getUserId());

        User deletedUser = userMapper.getUserById(1);
